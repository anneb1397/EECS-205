...
ml /I%MASMINCPATH% /c  /coff  /Cp math.asm
...
ml /I%MASMINCPATH% /c  /coff  /Cp AI.asm

if %errorlevel% neq 0 goto :error

ml /I%MASMINCPATH% /c  /coff  /Cp effects.asm

if %errorlevel% neq 0 goto :error

ml /I%MASMINCPATH% /c  /coff  /Cp collision.asm

if %errorlevel% neq 0 goto :error

ml /I%MASMINCPATH% /c  /coff  /Cp spawn.asm

if %errorlevel% neq 0 goto :error

ml  /c  /coff  /Cp sprites.asm 
if %errorlevel% neq 0 goto :error

ml  /c  /coff  /Cp Background.asm 
if %errorlevel% neq 0 goto :error


link /SUBSYSTEM:WINDOWS  /LIBPATH:%MASMLIBPATH% game.obj blit.obj trig.obj levels.obj AI.obj effects.obj math.obj collision.obj spawn.obj lines.obj sprites.obj Background.obj libgame.obj
