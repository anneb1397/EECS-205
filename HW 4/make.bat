...
ml  /c  /coff  /Cp aggressiveFish.asm 
if %errorlevel% neq 0 goto :error

ml  /c  /coff  /Cp clam.asm 
if %errorlevel% neq 0 goto :error

ml  /c  /coff  /Cp mermaidPlayerBase.asm 
if %errorlevel% neq 0 goto :error

ml  /c  /coff  /Cp deadFish.asm 
if %errorlevel% neq 0 goto :error

ml  /c  /coff  /Cp hook.asm 
if %errorlevel% neq 0 goto :error


link /SUBSYSTEM:WINDOWS  /LIBPATH:%MASMLIBPATH% game.obj blit.obj trig.obj lines.obj stars.obj aggressiveFish.obj clam.obj hook.obj deadFish.obj mermaidPlayerBase.obj libgame.obj
